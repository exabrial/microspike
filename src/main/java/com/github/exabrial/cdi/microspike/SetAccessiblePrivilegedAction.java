...
/**
 * PrivilegedAction instance to enabling access to the specified {@link AccessibleObject}. It's only useful if
 * {@link System#getSecurityManager()} returns a {@link SecurityManager}.
 */
@Typed()
